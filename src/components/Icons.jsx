...
export const WrenchIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RulerIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21.3 8.7l-5.6-5.6c-1-1-2.5-1-3.4 0L9.6 4.6c-1 1-1 2.5 0 3.4l5.6 5.6c1 1 2.5 1 3.4 0l2.7-2.7c1-1 1-2.5 0-3.4z"></path>
    <path d="M14.5 2.5l2.7 2.7"></path>
    <path d="M17.2 5.2l-9 9"></path>
    <path d="M9.5 13.5l2.7 2.7"></path>
  </svg>
);

export const FuelIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const PaletteIcon = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="13.5" cy="6.5" r=".5"></circle>
    <circle cx="17.5" cy="10.5" r=".5"></circle>
    <circle cx="8.5" cy="7.5" r=".5"></circle>
    <circle cx="6.5" cy="12.5" r=".5"></circle>
    <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.5-.662-.5-1.187a1.567 1.567 0 0 1 1.567-1.567c1.172 0 2.122.95 2.122 2.122 0 .656-.285 1.25-.656 1.656a3.5 3.5 0 0 0 .656 4.781c.343.305.656.64.656 1.125 0 .926-.746 1.648-1.688 1.648C17.5 22 22 17.5 22 12S17.5 2 12 2z"></path>
  </svg>
);
...
export const StarFillIcon = ({ size = 24, color = 'currentColor' }) => (
